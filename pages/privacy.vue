<template>
  <NuxtLayout name="default">
    <div class="prose mx-auto">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            the Company downloaded by You on any electronic device, named Push
            To Mac
          </p>
        </li>
        <li>
          <p>
            ...
            this Agreement) refers to Push To Mac.
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: privacy@pushtomac.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:
            <a
              href="https://pushtomac.com/contact"
              rel="external nofollow noopener"
              target="_blank"
              >https://pushtomac.com/contact</a
            >
          </p>
        </li>
      </ul>
